\begin{figure}
    \begin{center}
        \begin{adjustbox}{width=0.4\textwidth}
            ...
            % Text Node
            \draw (315.37,94.25) node   [align=left] {$\displaystyle \dots$};
            % Text Node
            \draw (377.91,95.99) node   [align=left] {$\displaystyle b_{t+1}^{N}$};
            % Text Node
            ...
            % Text Node
            \draw (377.91,335.46) node   [align=left] {$\displaystyle \hat{Env}_{t}$};
            \end{tikzpicture}
        \end{adjustbox}
    \end{center}
