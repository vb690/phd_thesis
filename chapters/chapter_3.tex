...
As we mentioned in chapter \ref{chapter_theory_modelling}, the underlying assumption of our approach is that the intensity of future behaviour can be predicted based on the history of interactions between an individual and a videogame. 
...
The the intensity of past behaviour is informative of 
