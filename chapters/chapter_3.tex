...
\label{implementation_testing_introduction}
 \footnote{All the code, excluding the SQL queries used for gathering the data, associated with the work presented in this chapter can be found in the following repositories \begin{itemize}
     \item \href{https://github.com/vb690/churn_survival_joint_estimation}{ChurnSurvivalJointEstimation}
...
\begin{equation}
\label{surv_eq}
   \mathbb{E}[\sum_{t_n}^{T} B_{t}] = f(B_{t_1 : t_n}; \theta)
\end{equation}
